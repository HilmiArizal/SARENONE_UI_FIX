...
import { getTransactionSuccess, editStatusTransaction, deleteTransaction } from '../../Redux/Actions';
...
class SuccessTransaction extends Component {
    ...
    componentDidMount() {
        this.props.getTransactionSuccess();
        this.getTransactionDetailSuccess();
    }

    getTransactionDetailSuccess = async () => {
        const res = await Axios.get(API_URL_1 + `transaction/getTransactionDetailSuccess`)
            ...
            <div>
                ...
                <div style={{ marginLeft: '15%' }}>
                    ...
                    <div className="section-status-transaction">
                        ...
                        <Link className="success-status-checked" to="transactionsuccess">
                            SUDAH BAYAR
                        </Link>
                    </div>
...
const mapStatetoProps = ({ transactionstatus }) => {
    return {
        dataTransactionSuccess: transactionstatus.dataTransactionSuccess
    }
}


export default connect(mapStatetoProps, { getTransactionSuccess, editStatusTransaction, deleteTransaction })(SuccessTransaction);