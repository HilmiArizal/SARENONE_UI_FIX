                                            ...
                                            <MDBContainer>
                                                <div className="grey-text">
                                                    <MDBInput
                                                        ...
                                                        onFocus={this.showWarningUsername}
                                                        onChange={this.handleChangePassword}
                                                        style={{ borderColor: this.state.showWarningUsername ? this.state.borderUsername ? '' : 'red' : '' }}
                                                    />
                                                    <MDBInput
                                                        label="Password"
                                                        icon="lock"
                                                        ...
                                                        onChange={this.handleChangePassword}
                                                        style={{ borderColor: this.state.showWarning ? this.state.border ? '' : 'red' : '' }}
                                                    />
                                                ...
                                                <MDBCard style={{ marginTop: 30, justifyContent: "center", padding: 20 }}>
                                                    ...
                                                    <div className="card-alternative-login">
                                                        <div><img src={gmailButton} alt="gmail-Login" style={{ width: 60, height: 30, borderRadius: 5, cursor: 'not-allowed' }} onClick={this.otherBtnLogin} /></div>

                                                        <div><img src={fbButton} alt="fb-Login" style={{ width: 60, height: 30, borderRadius: 5, cursor: 'not-allowed' }} onClick={this.otherBtnLogin} /></div>

                                                        <div><img src={twitterButton} alt="twitter-Login" style={{ width: 60, height: 30, borderRadius: 5, cursor: 'not-allowed' }} onClick={this.otherBtnLogin} /></div>
                                                    </div>
