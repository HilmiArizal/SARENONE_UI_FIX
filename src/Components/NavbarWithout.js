...
class NavbarWithout extends Component {
    ...
    renderProfile = () => {
        return (
            <MDBRow>
                <MDBCol size="2">
                    <MDBIcon icon="fas fa-history" size="sm" style={{ margin: 13 }} />
                </MDBCol>
                <MDBCol size="10">
                    <MDBDropdownItem href="historytransaction" style={{fontSize:13}}>Riwayat Transaksi</MDBDropdownItem>
                </MDBCol>
                <MDBCol size="2">
                    <MDBIcon icon="sign-out-alt" size="sm" style={{ margin: 13 }} />
                </MDBCol>
                <MDBCol size="10">
                    <MDBDropdownItem href="/" onClick={this.onBtnLogout} style={{fontSize: 13}}>Keluar</MDBDropdownItem>
                </MDBCol>
            </MDBRow>
            ...
            <MDBNavbar color="#c62828 red darken-3" dark expand="md" >
                <MDBContainer>
                    ...
                    <MDBCollapse id="navbarCollapse3" isOpen={this.state.isOpen} navbar >
                        <MDBNavbarNav left >
                            <MDBNavItem >
                                <a id="font-Navbar" href="/">Beranda</a>
                            </MDBNavItem>
                            <MDBNavItem>
                                <a id="font-Navbar" href="/product">Produk</a>
                            </MDBNavItem>
                        </MDBNavbarNav>
                        {
                            this.props.username
...
export default connect(mapStatetoProps, { logoutUser, getCart })(NavbarWithout);